            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div >
                    ...
                    <div className="flex items-center space-x-2 mt-2">
                        ...
                        <span className="text-sm text-gray-600 mt-1">4.5/5</span>
                    </div>
                    <div className="flex items-center mt-4 gap-5">
                    <p className='text-2xl text-black font-bold'>$120</p>
                        <p className="text-lg line-through font-bold text-gray-400">$300</p>
                        <p className='bg-[#FFEBEB] text-[#FF3333] text-sm px-3 py-1 my-auto rounded-full'> - 30% </p>
                    </div>
