  ...
  return (
    <div className="mx-auto container">
        <div className="grid grid-cols-1 md:grid-cols-2 p-10 gap-10">
            <div>
                <h1 className="mt-10 font-bold  md:text-xl lg:text-4xl uppercase  "> Join our affiliate team </h1>
                ...
                <button className="bg-[#D9D9D9] px-4 py-2 mt-5 font-semibold rounded-md">Get Started Today</button>
            </div>

            <div className='flex items-center'>
                <img src={affiliate} className='mx-auto rounded-lg w-full  md:w-2/3 h-auto' />
            </div>
        </div>
    </div>
  )
